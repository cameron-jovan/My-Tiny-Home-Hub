...
const NAV_ITEMS = [
  ...
  { label: 'Editorial Hub', icon: (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M11 15h2m-2-3h2m-2-3h2m-2-3h2m-2 15h2m-4-18h6a2 2 0 0 1 2 2v16a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h6z"/>
      <path d="M12 22v-3m0-16v3"/>
    </svg>
  ), href: '/editorial' },
