...
export default function SignupPage() {
  ...
  return (
    <main className={styles.authPage} id="signup-page">
      <div className={styles.authContainer}>
        <h1>Create Account</h1>
        <p className={styles.authSubtitle}>Join the My Tiny Home Hub community</p>
        
        {error && <div className={styles.errorBanner}>{error}</div>}

        <button 
          onClick={handleGoogleSignup} 
          className={styles.btnSocialGoogle} 
        ...
        <form onSubmit={handleEmailSignup} className={styles.authForm}>
          ...
          <button type="submit" className={`btn btn-primary ${styles.btnFull}`} disabled={loading}>
